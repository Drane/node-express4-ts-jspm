...
System.config({
    "map": {
        "jasmine-node": "npm:jasmine-node@2.0.0",
        ...
        "npm:jasmine-growl-reporter@0.2.1": {
            "growl": "npm:growl@1.7.0",
            "path": "github:jspm/nodelibs-path@0.1.0"
        },
        "npm:jasmine-node@2.0.0": {
            "child_process": "github:jspm/nodelibs-child_process@0.1.0",
            "coffee-script": "npm:coffee-script@1.7.1",
            "fs": "github:jspm/nodelibs-fs@0.1.2",
            "gaze": "npm:gaze@0.5.1",
            "jasmine-growl-reporter": "npm:jasmine-growl-reporter@0.2.1",
